...
ActorSystem.prototype.actorOf = function(clss, name) {
    return newActor(clss, this, null, name);
}
...
function newActor(clss, system, parent, name) {
    ...
    var ref = new ActorRef(actor, system, parent, name);
...
ActorContext.prototype.actorOf = function(clss, name) {
    return newActor(clss, this.system, this.self, name);
}

function ActorRef(actor, system, parent, name) {
    this.actor = actor;
    
    if (parent)
        this.path = parent.path + "/" + (name ? name : system.nextNumber());
    else
        this.path = "sactors://" + system.getName() + "/" + (name ? name : system.nextNumber());
}
