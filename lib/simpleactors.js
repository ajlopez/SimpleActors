...
exports.asMessageActor = function(obj, mthname)
{
    if (!mthname)
        mthname = 'process';
        
    obj._isMessageActor = true;
    obj.post = makePost(obj, obj[mthname]);
    
    return obj;
    //return new MessageActorWrapper(obj, mthname);
}

exports.isActor = function(actor)
{
    return actor._isActor ? true : false;
}

exports.isMessageActor = function(actor)
{
    return actor._isMessageActor ? true : false;
}
