...
ActorSystem.prototype.actorOf = function(clss, name) {
    return newActor(clss, this, name);
}

function newActor(clss, system, name) {
    var actor;
    ...
    var context = new ActorContext(system);
    actor.context = context;
    var ref = new ActorRef(actor);
    ref.path = "sactors://" + system.getName() + "/" + (name ? name : system.nextNumber());
    context.self = ref;
    actor.self = ref;
    return ref;
}

function ActorContext(system) {
    this.system = system;
}

ActorContext.prototype.actorOf = function(clss) {
    return newActor(clss, this.system);
}
